...
/**
 * Описание уведомления-квитанции о постановке документа на контроль
 * 
 * <p>Java class for stateNewControl complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="stateNewControl"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "stateNewControl", namespace = "http://esedo.nitec.kz/service/model/notification", propOrder = {
    "controlTypeCode",
    "controlTypeNameKz",
    "controlTypeNameRu",
    "execDate"
})
public class StateNewControl
    extends Message
{
