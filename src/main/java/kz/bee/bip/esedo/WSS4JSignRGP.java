...
public class WSS4JSignRGP  {
    private static final Logger LOGGER= LogManager.getLogger(WSS4JSignRGP.class);
    ...
    public void signMessage1(SOAPMessage message) throws ParserConfigurationException, KeyStoreException,
            NoSuchProviderException, PrivilegedActionException, XMLSecurityException, UnrecoverableKeyException, NoSuchAlgorithmException, IOException, CertificateException, SOAPException {
...
//                        result = signature.checkSignatureValue(cert);
    ...
    private void check(Boolean result) {
        if (!result) {
            java.lang.System.err.println("Verification failed");
