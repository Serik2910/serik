...
/**
 * Описание уведомления-квитанции о изменении срока исполнения
 * 
 * <p>Java class for stateNewExDate complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="stateNewExDate"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "stateNewExDate", namespace = "http://esedo.nitec.kz/service/model/notification", propOrder = {
    "controlTypeCode",
    "controlTypeNameKz",
    "controlTypeNameRu",
    "execDate"
})
public class StateNewExDate
    extends Message
{
