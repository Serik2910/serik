...
public class GetMessageStatusGetMessageStatusFaultMsg
    extends Exception
{
     ...
     * @param message
     */
    public GetMessageStatusGetMessageStatusFaultMsg(String message, ErrorInfo faultInfo) {
        super(message);
     ...
     * @param message
     */
    public GetMessageStatusGetMessageStatusFaultMsg(String message, ErrorInfo faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
